...
> classic Helm repository at `https://ephico2real2.github.io/cf2cnp` (chart 0.5.1, appVersion 0.5.1) and its image as
> `ghcr.io/ephico2real2/cf2cnp:0.5.1`. `helm repo add cf2cnp-fork https://ephico2real2.github.io/cf2cnp`.
